...
class Group:
    ...
    def forget(self, name1, name2):
        ...
        for connect in self.connections[name1]:
            if connect[0] == name2:
                self.connections[name1].remove(connect)
        for connect in self.connections[name2]:
            if connect[0] == name1:
                self.connections[name2].remove(connect)     
